    ...
    def add_gems
      inside @app_path do
        ...
        if @install_default_gateways
          gem :spree_gateway, :path => 'vendor/gems/spree_gateway' #, :git => "https://github.com/spree/spree_gateway.git", :branch => "2-2-stable"
        end

        if @install_default_auth
          gem :spree_auth_devise, :path => 'vendor/gems/spree_auth_devise' #, :git => "https://github.com/spree/spree_auth_devise.git", :branch => "2-2-stable"
        end
