...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<spree_backend>, ["= 2.2.2"])
      s.add_runtime_dependency(%q<spree_frontend>, ["= 2.2.2"])
      s.add_runtime_dependency(%q<spree_sample>, ["= 2.2.2"])
      s.add_runtime_dependency(%q<spree_cmd>, ["= 2.2.2"])
    else
      s.add_dependency(%q<spree_core>, ["= 2.2.2"])
      s.add_dependency(%q<spree_api>, ["= 2.2.2"])
      s.add_dependency(%q<spree_backend>, ["= 2.2.2"])
      s.add_dependency(%q<spree_frontend>, ["= 2.2.2"])
      s.add_dependency(%q<spree_sample>, ["= 2.2.2"])
      s.add_dependency(%q<spree_cmd>, ["= 2.2.2"])
    end
  else
    s.add_dependency(%q<spree_core>, ["= 2.2.2"])
    s.add_dependency(%q<spree_api>, ["= 2.2.2"])
